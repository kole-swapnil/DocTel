...
const distributeUsers = () => {
    let remainingUsers = 400;
    let userDistribution = new Array(RPC_URLS.length).fill(20); // minimum 40 users per URL
    remainingUsers -= RPC_URLS.length * 20; // Subtract the allocated
